...
class PlaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post plays_url, params: { play: { file_url: @play.file_url, filename: @play.filename, timer: @play.timer } }
    end
  ...
  test "should update play" do
    patch play_url(@play), params: { play: { file_url: @play.file_url, filename: @play.filename, timer: @play.timer } }
